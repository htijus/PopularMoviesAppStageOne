...
public class MainActivity extends AppCompatActivity implements MovieFragment.ListActionListener{
    ...
    @Override
    public void onMovieSelected(MovieResponseList.Movie movie) {
